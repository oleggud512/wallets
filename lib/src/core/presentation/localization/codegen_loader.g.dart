...
class CodegenLoader extends AssetLoader {
  ...
  static const Map<String, dynamic> ru = {
    ...
    "verificationMailMessage":
        "На вашу электронную почту отправлено письмо для подтверждения.",
    ...
    "deleteAccountMessage":
        "Введите данные вашего аккаунта чтобы подтвердить удаление",
    ...
    "addFirstWalletHelperText":
        "Нажмите на эту кнопку чтобы добавить первый кошелек!"
  };
  static const Map<String, dynamic> en = {
    ...
    "theme": "Theme",
    "emailErrors": {"notFound": "Email not found", "invalid": "Invalid email"},
    "passwordErrors": {
