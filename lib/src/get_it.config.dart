...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> initialize({
    ...
    gh.factory<_i11.SignInWithEmailAndPasswordUseCase>(
        () => _i11.SignInWithEmailAndPasswordUseCase(gh<_i5.AuthRepository>()));
    gh.factory<_i12.SignOutUseCase>(
        () => _i12.SignOutUseCase(gh<_i5.AuthRepository>()));
    ...
    gh.factory<_i18.AddTagUseCase>(
        () => _i18.AddTagUseCase(gh<_i15.TagsRepository>()));
    gh.factory<_i19.DeleteTagUseCase>(
        () => _i19.DeleteTagUseCase(gh<_i15.TagsRepository>()));
    ...
    gh.factory<_i26.AddWalletUseCase>(
        () => _i26.AddWalletUseCase(gh<_i22.WalletsRepository>()));
    gh.factory<_i27.DeleteWalletUseCase>(
        () => _i27.DeleteWalletUseCase(gh<_i22.WalletsRepository>()));
    gh.factory<_i28.UpdateWalletDescriptionUseCase>(() =>
        _i28.UpdateWalletDescriptionUseCase(gh<_i22.WalletsRepository>()));
    gh.factory<_i29.WatchWalletsUseCase>(
        () => _i29.WatchWalletsUseCase(gh<_i22.WalletsRepository>()));
    gh.factory<_i30.WatchWalletUseCase>(
        () => _i30.WatchWalletUseCase(gh<_i22.WalletsRepository>()));
    gh.factory<_i31.DeleteHistoryNodeUseCase>(
        () => _i31.DeleteHistoryNodeUseCase(gh<_i24.HistoryRepository>()));
    gh.factory<_i32.MakeTransactionUseCase>(
        () => _i32.MakeTransactionUseCase(gh<_i24.HistoryRepository>()));
