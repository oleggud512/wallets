...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> initialize({
    ...
    gh.singleton<_i15.WalletsRepository>(
        _i16.FirebaseWalletsRepositoryImpl(gh<_i9.FirebaseUserDataSource>()));
    gh.factory<_i17.WatchTagsUseCase>(
        () => _i17.WatchTagsUseCase(gh<_i13.TagsRepository>()));
    gh.factory<_i18.WatchWalletsUseCase>(
        () => _i18.WatchWalletsUseCase(gh<_i15.WalletsRepository>()));
    gh.factory<_i19.AddTagUseCase>(
        () => _i19.AddTagUseCase(gh<_i13.TagsRepository>()));
    gh.factory<_i20.AddWalletUseCase>(
        () => _i20.AddWalletUseCase(gh<_i15.WalletsRepository>()));
    gh.factory<_i21.DeleteTagUseCase>(
        () => _i21.DeleteTagUseCase(gh<_i13.TagsRepository>()));
    gh.factory<_i22.DeleteWalletUseCase>(
        () => _i22.DeleteWalletUseCase(gh<_i15.WalletsRepository>()));
    return this;
  }
}
