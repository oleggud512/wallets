...
sealed class AddWalletPageEvent with _$AddWalletPageEvent {
  ...
  factory AddWalletPageEvent.amountChanged(double amount) =
      AddWalletPageAmountChangedEvent;
  factory AddWalletPageEvent.currencyChanged(String currency) =
      AddWalletPageCurrencyChangedEvent;
  factory AddWalletPageEvent.addWallet(VoidCallback onComplete) =
      AddWalletPageAddWalletEvent;
}
