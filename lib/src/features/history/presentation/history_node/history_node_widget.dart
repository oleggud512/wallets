...
class _HistoryNodeWidgetState extends State<HistoryNodeWidget> {
  ...
  editHistoryNodeDescription() async {
    ...
    getIt.hardcoded<UpdateHistoryNodeUseCase>()(
        widget.walletId, widget.historyNode.hid, newDescr);
  }
            ...
            child: Padding(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    buildTag(),
                    if (historyNode.description.isNotEmpty)
                      Padding(
  ...
  Widget withPopup(BuildContext context, {Widget? child}) {
    return PopupMenuButton<Symbol>(
        ...
        itemBuilder: (context) {
          return [
            PopupMenuItem(
                value: #edit, child: Text(context.tr(LocaleKeys.edit))),
            PopupMenuItem(
                value: #delete, child: Text(context.tr(LocaleKeys.delete)))
          ];
        },
        onSelected: (i) async {
  ...
  Widget buildHistoryNodeData(BuildContext context) {
    return Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Text(
        '${historyNode.action == WalletAction.add ? '+' : '-'}${widget.historyNode.amount}',
  ...
  Widget buildTag() {
    ...
    return Padding(
        padding: const EdgeInsets.only(top: p4), child: TagWidget(tag: tag));
  }
}
